...
File Summary
  ...
  - HDL source -
  /media/dung/anhqvn/FPGA11/contrib-projects/hrav_framework_b_finall3/hw/pcores/pr_hrav_collector_v1_00_a/hdl/vhdl
  top level      : pr_hrav_collector.vhd

  - ISE project -
  /media/dung/anhqvn/FPGA11/contrib-projects/hrav_framework_b_finall3/hw/pcores/pr_hrav_collector_v1_00_a/devl/projnav
  ise project    : pr_hrav_collector.xise
  tcl script     : pr_hrav_collector.tcl


  - XST synthesis -
  /media/dung/anhqvn/FPGA11/contrib-projects/hrav_framework_b_finall3/hw/pcores/pr_hrav_collector_v1_00_a/devl/synthesis
  xst script     : pr_hrav_collector_xst.scr
  xst project    : pr_hrav_collector_xst.prj

  - Misc file -
  /media/dung/anhqvn/FPGA11/contrib-projects/hrav_framework_b_finall3/hw/pcores/pr_hrav_collector_v1_00_a/devl
  help           : README.txt
  option         : ipwiz.opt
  log            : ipwiz.log
...
written into src/pr_hrav_collector.c in the Driver Directory.
...
implemented in hdl/vhdl/pr_hrav_collector.vhd in the Core Directory.
