/*****************************************************************************
* Filename:          /home/eagle/NetFPGA10/contrib-projects/hravcore/hw/drivers/hravframework_v1_00_a/src/hravframework.h
* Version:           1.00.a
* Description:       hravframework () Driver Header File
* Date:              Thu Oct  2 03:45:34 2014 (by Create and Import Peripheral Wizard)
*****************************************************************************/

#ifndef HRAVFRAMEWORK_H
#define HRAVFRAMEWORK_H
...
*    example code (hravframework_selftest.c) for details.
*/

#define  hravframework(\
		 input_slot_id,\
		 output_slot_id,\
		 input_0,      \
		 output_0       \
