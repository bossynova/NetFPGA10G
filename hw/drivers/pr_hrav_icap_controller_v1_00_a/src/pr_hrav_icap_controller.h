/*****************************************************************************
* Filename:          /media/dung/anhqvn/FPGA11/contrib-projects/hrav_framework_b_finall3/hw/drivers/pr_hrav_icap_controller_v1_00_a/src/pr_hrav_icap_controller.h
* Version:           1.00.a
* Description:       pr_hrav_icap_controller () Driver Header File
* Date:              Sun Feb  8 16:10:53 2015 (by Create and Import Peripheral Wizard)
*****************************************************************************/

#ifndef PR_HRAV_ICAP_CONTROLLER_H
#define PR_HRAV_ICAP_CONTROLLER_H
...
*    example code (pr_hrav_icap_controller_selftest.c) for details.
*/

#define  pr_hrav_icap_controller(\
		 input_slot_id,\
		 output_slot_id,\
		 input_0,      \
		 output_0       \
