/*****************************************************************************
* Filename:          /media/dung/anhqvn/FPGA11/contrib-projects/hrav_framework_b_finall3/hw/drivers/pr_hrav_collector_v1_00_a/src/pr_hrav_collector.h
* Version:           1.00.a
* Description:       pr_hrav_collector () Driver Header File
* Date:              Sun Feb  8 19:34:27 2015 (by Create and Import Peripheral Wizard)
*****************************************************************************/

#ifndef PR_HRAV_COLLECTOR_H
#define PR_HRAV_COLLECTOR_H
...
*    example code (pr_hrav_collector_selftest.c) for details.
*/

#define  pr_hrav_collector(\
		 input_slot_id,\
		 output_slot_id,\
		 input_0,      \
		 output_0       \
...
XStatus PR_HRAV_COLLECTOR_SelfTest();
